...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["I Live in New Delhi,India.","I am a Freelancer.", "I am a Developer."],    /* You can change the home section typing text from
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            html: "<b>Address</b>: <br> KarkarDooma, Delhi - 110092, India.",   /* You can change display address text from here */
            popup: true
            }
            ]
            });
